...
var steps = ['"Where there is a will, there is a way. If there is a chance in a million that you can do something, anything, to keep what you want from ending, do it. Pry the door open or, if need be, wedge your foot in that door and keep it open."', 
...
function nextStep() {
  document.getElementById("step").innerHTML = steps[numClicks];


  if(numClicks == (steps.length - 1)){
    numClicks = 0;
  }
    numClicks++;
